package prjava43arrebola20;
import java.awt.*; // using AWT containers and components
import java.awt.event.*; // using AWT events and listener interfaces
import java.net.*;
// An AWT GUI program inherits the top-level container java.awt.Frame
public class Prjava43arrebola20 extends Frame
...
setTitle("nova finestra prjava43arrebola20"); // "this" Frame sets title
...
new Prjava43arrebola20(); // Let the construct do the job
}
/** ActionEvent handler */
@Override
